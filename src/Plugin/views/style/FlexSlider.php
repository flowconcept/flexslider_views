...
class FlexSlider extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['flexslide_selector']['default'] = '.slides > li'; //Selector: Must match a simple pattern. '{container} > {slide}' -- Ignore pattern at your own peril
    $options['flexslide_animation']['default'] = 'fade'; //String: Select your animation type, "fade" or "slide"
